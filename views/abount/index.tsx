			...
			<Container>
				...
				<Grid container>
					...
					<ContentFont md>
						...
						프로그래밍에 대해 공부하고 싶어 서강대학교 컴퓨터공학과에 진학을 하였고, 후에 공부를 좀 더 해보고 싶은 마음에 서강대학교 데이터베이스 연구실에서 석사학위를 취득했습니다.
						후에 티맥스 데이터에 취직하여 전문연을 시작하였습니다. 티맥스 데이터에 와서 맡은 업무는 데이터베이스 모니터링 프로그램을 개발하는 일이었습니다. 그 중에서도 저는 프론트엔드 부문을 맡아 개발을 하였습니다.
						처음에는 top.js라는 자사의 소프트웨어를 이용하여 개발을 시작하였고, 이 과정에서 프론트엔드에 관심을 가지게 되어 혼자서 공부를 시작하게 되었습니다. 그 중 운좋게도 회사의 다른 동료들과 퇴근 후에 사이드 프로젝트를 진행하면서
						react를 공부하고 있었습니다. 그러던 와중에 회사에서 사용하던 top.js를 react로 전환하게 되었고, 이를 맡아 성공적으로 진행하였습니다. 또한 회사 동료들과 계속해서 사이드 프로젝트를 진행하며 실력을 늘리고 있습니다.
					</ContentFont>
